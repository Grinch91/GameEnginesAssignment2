...
namespace BGE
{
    public class SteeringManager : MonoBehaviour
    {
		...
		public GameObject humanFighterPrefab;
		public GameObject humanleaderPrefab;
		public GameObject oriFighterPrefab;
		public GameObject orileaderPrefab;
		public GameObject goauldFighterPrefab;
		public GameObject goauldleaderPrefab;
		public GameObject asgardPrefab;
        ...
        void Start()
        {
			...
			scenarios.Add(new BattleScene2());
			scenarios.Add(new BattleScene3());
			scenarios.Add(new BattleScene4());
			scenarios.Add(new BattleScene5());
			scenarios.Add(new BattleScene6());
			scenarios.Add(new BattleScene7());
        ...
        void Update()
        {
           ...
           /* PrintMessage("Press F1 to toggle camera mode");
			...
			PrintMessage("Current time passed" + seconds);
